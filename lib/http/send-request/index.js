...
import { request as sendHttpsRequest, Agent as HttpsAgent } from 'https'
...
export default async function(request) {
  ...
  return {
    ...
    body: nodeResponse.headers['content-type'] && nodeResponse.headers['content-type'].includes('application/json')
